...
DataLoader.prototype = {
	...
	loadSampleData: function (callback) {
		...
		// Path can change depending on the environment.
		if (fs.existsSync('./models/data/sampleData.json')) {
			data = fs.readFileSync('./models/data/sampleData.json', 'utf-8');
		} else if (fs.existsSync('../models/data/sampleData.json'))   {
			data = fs.readFileSync('../models/data/sampleData.json', 'utf-8');
		}
